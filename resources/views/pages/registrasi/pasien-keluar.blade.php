...
<div class="w-full bg-white">
    <div class="space-y-8">
        <div class="head">
            <h2 class="text-3xl font-bold">Registrasi Pasien Keluar Rawat Inap</h2>
        </div>
    ...
    <div class="shadow border p-5 mt-20 bg-white">
        <div class="p-2 lg:flex grid space-y-5 grid-cols-1 justify-between">
            <div class="mt-3 w-full">
                <h2 class="text-2xl font-bold">Table Pasien Keluar</h2>
            </div>
        ...
        {{-- Table --}}
        <x-content.table :headers="['No','No.RM','Nama','Tanggal Lahir','Jenis Kelamin','Ruang RI', 'Action']" :rows="[]" />
    </div>
</div>
@endsection