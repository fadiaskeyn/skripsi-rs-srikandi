        ...
        <div class="w-full flex justify-end">
            <div class="dropdown border-l p-5 hover:bg-neutral-100">
                <button class="dropdown-account-toggle mt-1 "><span
                        class="flex gap-5 mt-0 font-semibold text-gray-600"><span>Noga Muktiwati</span>
                ...
                <div class="dropdown-menu hidden">
                    <div class="avatar-account flex gap-1 border-b p-2">
                        <div class="avatar-profile p-3">
                            <img src="https://ui-avatars.com/api/?name=Noga Muktiwati" class="w-12 rounded-full"
                                alt="" srcset="">
                        </div>
                        <div class="avatar">
                            <h2 class="font-bold">Noga Muktiwati</h2>
                            <p class="text-sm">Kepala RM</p>
                        </div>
                    </div>
